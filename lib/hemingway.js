...
import filmDescriptions from "./film-descriptions.json";
...
// Opening phrases — 5 poetic, cinephile-toned variations per DNA type per language.
// One is picked at random each time, so the same film can read differently on a reroll.
const DNA_OPENERS = {
  el: {
    d:  ["Εικόνες που κινούνται σαν όνειρο.", "Ατμόσφαιρα πάνω από αφήγηση.", "Κάτι υπαινικτικό που δεν λύνεται.", "Ο χρόνος εδώ ρέει αλλιώς.", "Ένα κάδρο που μοιάζει να θυμάται όνειρο κάποιου άλλου."],
    st: ["Ερώτημα χωρίς εύκολη απάντηση.", "Σιωπή που λέει περισσότερα από τα λόγια.", "Ηθική που δεν συγχωρεί.", "Μια ταινία που σε κοιτά στα μάτια.", "Μια συνείδηση που δεν σου αφήνει διαφυγή."],
    h:  ["Πρόσωπο που θυμάσαι μετά.", "Απλή ανθρώπινη αλήθεια.", "Στιγμή που μετρά.", "Κάτι μικρό που γίνεται μεγάλο.", "Η καθημερινότητα, κινηματογραφημένη σαν να είναι ιερή."],
    of: ["Κάθε κάδρο μελετημένο.", "Η φόρμα είναι το μήνυμα.", "Κινηματογράφος που ξέρει τι κάνει.", "Γεωμετρία και φως σε συνομιλία.", "Ένας σκηνοθέτης που σχεδιάζει σαν αρχιτέκτονας."],
    r:  ["Μελαγχολία που είναι όμορφη.", "Έρωτας που αφήνει σημάδι.", "Ατμόσφαιρα που μένει μετά τους τίτλους.", "Κάτι που χάθηκε πριν ειπωθεί.", "Ένας πόνος τόσο κομψός που μοιάζει με τραγούδι."],
    c:  ["Κάτι για τον κόσμο όπως πραγματικά είναι.", "Εξουσία που αποκαλύπτεται.", "Κοινωνία κάτω από μικροσκόπιο.", "Αυτό που δεν θέλουμε να δούμε.", "Μια κάμερα που δεν διστάζει να κατηγορήσει."],
    ea: ["Μεγάλη ιστορία, μεγάλοι χαρακτήρες.", "Αφήγηση που κρατά από την αρχή.", "Μύθος σε κινούμενη εικόνα.", "Η κλίμακα έχει σημασία εδώ.", "Μια εποποιία που χωράει μέσα της γενιές."],
    op: ["Κάτι κάτω από την επιφάνεια.", "Εμμονή που δεν εξηγείται.", "Το ασυνείδητο ως σκηνικό.", "Μια ταινία που μένει στο σώμα.", "Ένας εφιάλτης που μοιάζει πολύ λογικός."],
    n:  ["Τοπίο που αναπνέει.", "Φύση ως δύναμη — όχι φόντο.", "Σιωπή που έχει βάρος.", "Ο χώρος είναι πρωταγωνιστής.", "Ένας άνεμος που κουβαλά όλη την ταινία."],
    pp: ["Ευφυΐα με ελαφράδα.", "Χιούμορ που δεν χάνει τη σοβαρότητά του.", "Παιχνίδι με φόρμα και ιδέες.", "Κάτι που σε κάνει να γελάς και μετά να σκέφτεσαι.", "Μια ειρωνεία τόσο λεπτή που χρειάζεται δεύτερη θέαση."],
    a:  ["Animation ως σοβαρή γλώσσα.", "Φαντασία που αγγίζει αλήθεια.", "Εικόνες που δεν χρειάζονται εξήγηση.", "Ο κόσμος χτισμένος από το μηδέν.", "Ένα πινέλο που ζωγραφίζει συναίσθημα καρέ προς καρέ."],
    ve: ["Ρυθμός και αφηγηματική ακρίβεια.", "Είδος στην τελειότητά του.", "Craftsmanship που δεν κρύβεται.", "Όλα στη θέση τους — και αυτό είναι το θαύμα.", "Ένας μηχανισμός που δεν χάνει ποτέ τον παλμό του."],
  },
  en: {
    d:  ["Images that move like a dream.", "Atmosphere over narrative.", "Something suggestive that does not resolve.", "Time flows differently here.", "A frame that seems to remember someone else's dream."],
    st: ["A question without an easy answer.", "Silence that says more than words.", "Morality that does not forgive.", "A film that looks you in the eye.", "A conscience that leaves you nowhere to hide."],
    h:  ["A face you remember after.", "Simple human truth.", "A moment that counts.", "Something small that becomes large.", "The everyday, filmed as if it were sacred."],
    of: ["Every frame deliberate.", "The form is the message.", "Cinema that knows exactly what it is doing.", "Geometry and light in conversation.", "A director who composes like an architect."],
    r:  ["A melancholy that is beautiful.", "Love that leaves a mark.", "Atmosphere that lingers after the credits.", "Something lost before it was said.", "A heartbreak elegant enough to sound like a song."],
    c:  ["Something about the world as it actually is.", "Power revealed.", "Society under a microscope.", "What we do not want to see.", "A camera that refuses to look away from blame."],
    ea: ["A big story, big characters.", "Narrative that holds from beginning to end.", "Myth in moving images.", "Scale matters here.", "An epic wide enough to hold generations."],
    op: ["Something beneath the surface.", "Obsession without explanation.", "The unconscious as a setting.", "A film that stays in the body.", "A nightmare that makes too much sense."],
    n:  ["Landscape that breathes.", "Nature as force — not background.", "Silence that has weight.", "Space is the protagonist.", "A wind that carries the whole film on its back."],
    pp: ["Intelligence with lightness.", "Humour that does not lose its seriousness.", "Play with form and ideas.", "Something that makes you laugh, then think.", "An irony so precise it needs a second viewing."],
    a:  ["Animation as a serious language.", "Fantasy that touches truth.", "Images that need no explanation.", "A world built from nothing.", "A brush painting feeling one frame at a time."],
    ve: ["Rhythm and narrative precision.", "Genre at its finest.", "Craftsmanship that does not hide.", "Everything in its place — and that is the miracle.", "A machine that never loses its pulse."],
  },
};
...
// True random selector — used for openers/closers so reroll feels alive
// rather than locked to one fixed phrase per film.
...
// Turn the recommendation engine's matchReasons (director / shared keywords /
// TMDB similarity) into one short, human sentence explaining the connection
// to the films the user already gave us.
function buildConnectionLine(matchReasons, lang) {
  if (!Array.isArray(matchReasons) || matchReasons.length === 0) return "";

  const directorReason = matchReasons.find((r) => r.type === "director");
  if (directorReason?.director) {
    return lang === "en"
      ? `Same hand behind the camera: ${directorReason.director} directed one of your films too.`
      : `Το ίδιο μάτι πίσω από την κάμερα: ο ${directorReason.director} έχει σκηνοθετήσει και μια από τις δικές σου ταινίες.`;
  }

  const keywordReason = matchReasons.find((r) => r.type === "keyword" && r.keywords?.length);
  if (keywordReason) {
    const moodWord = keywordReason.keywords[0];
    return lang === "en"
      ? `It shares a mood with your picks — ${moodWord}.`
      : `Μοιράζεται κλίμα με τις επιλογές σου — ${moodWord}.`;
  }

  const similarReason = matchReasons.find((r) => r.type === "similar" && r.films?.length);
  if (similarReason) {
    const sourceTitle = similarReason.films[0];
    return lang === "en"
      ? `Fans of ${sourceTitle} also love this one.`
      : `Όσοι αγάπησαν το «${sourceTitle}» αγαπούν και αυτή.`;
  }
...
// MAIN GENERATOR
// ===================================================================
export function generateWhy(film, dnaType, mood, lang = "el", matchReasons = []) {
  const connectionLine = buildConnectionLine(matchReasons, lang);

  // 0. Per-film hand-written description keyed by TMDB id (highest priority,
  // for when lib/film-descriptions.json gets populated over time).
  const byId = film?.id != null ? filmDescriptions[String(film.id)] : null;
  if (byId) {
    const base = lang === "en" ? (byId.en || byId.el) : (byId.el || byId.en);
    if (base) return connectionLine ? `${base} ${connectionLine}` : base;
  }

  // 1. Check curated list (for ~50 famous films)
  const normTitle = normalizeTitle(film?.title || "");
  const curated = CURATED[normTitle];
  if (curated) {
    const base = lang === "en" ? (curated.en || curated.el) : curated.el;
    return connectionLine ? `${base} ${connectionLine}` : base;
  }
  ...
  // Pick opener and closer at random — same film can read differently on reroll
  ...
  // COMPOSE — three strategies based on available data, plus the connection
  // line appended at the end when we have one.

  // Strategy A: We have an image from overview → use it as the concrete hook
  if (image) {
    return [opener, image, closer, connectionLine].filter(Boolean).join(" ");
  }

  // Strategy B: We have a tagline → quote it in context
  if (tagline) {
    const connector = lang === "en" ? `"${tagline}"` : `«${tagline}»`;
    return [opener, connector, closer, connectionLine].filter(Boolean).join(" ");
  }
  ...
  return [opener, directorLine, closer, connectionLine].filter(Boolean).join(" ");
}
